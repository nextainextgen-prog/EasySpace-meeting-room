...
export function MemberLoginForm() {
  ...
  return (
    <div className="mt-7 space-y-3">
      ...
      {/* Official-style Google button — white bg, full color G mark */}
      <button
        type="button"
      ...
      <p className="text-[11px] text-ink-3 text-center leading-relaxed">
        ใช้บัญชี Google ที่อีเมลตรงกับที่ลงทะเบียนกับองค์กรของคุณ
      </p>
    </div>
  );
}

/** Official Google "G" mark — for white button per Google brand guidelines. */
