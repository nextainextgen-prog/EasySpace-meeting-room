...
export const metadata = {
  title: "ติดต่อแอดมินตึก — EasySpace",
};
      ...
      <main className="relative w-full max-w-md">
        ...
        <div className="rounded-[28px] bg-white px-8 py-10 sm:px-10 sm:py-11 shadow-[0_30px_80px_-20px_rgba(15,23,42,0.35)]">
          ...
          <p className="mt-2 text-sm text-ink-3 tracking-tight">
            พนักงานภายในต้องได้รับลิงก์เชิญจากแอดมินขององค์กรคุณ
          </p>
...
function ContactItem({
  ...
  return (
    <li>
      <a
        href={href}
        className="flex items-center gap-3 h-14 px-5 rounded-pill bg-white border border-line hover:border-primary-300 hover:bg-surface-subtle transition-all"
      >
        ...
        <div className="flex-1">
          ...
          <p className="text-sm font-medium text-ink-1 tracking-tight">
            {value}
          </p>
        </div>
      </a>
